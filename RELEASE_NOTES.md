...
## v1.1.27
GH#745 — declare per-step `output: {name, type}` on every execution step (audience_analysis/text, ideas/list, brief/text, polished_calendar/text). Lights up the #744 rich flow-map. Content-only; no bindings or logic changes.
